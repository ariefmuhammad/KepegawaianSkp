        ...
        START - Main Menu
        -------------------->
        <div class="menu-w color-scheme-light color-style-light menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
            <div class="logo-w">
            ...
            <ul class="main-menu">
              ...
              <li class=" has-sub-menu">
                <a href="layouts_menu_top_image.html">
                  ...
                  <span>Seminar / Lokakarya / Simposium</span></a>
                <div class="sub-menu-w">
                  <div class="sub-menu-header">
              ...
              <li class=" has-sub-menu">
                <a href="layouts_menu_top_image.html">
                  ...
                  <span>Tanda Jasa / Penghargaan</span></a>
                <div class="sub-menu-w">
                  <div class="sub-menu-header">
              ...
              <li class=" has-sub-menu">
                <a href="layouts_menu_top_image.html">
                  ...
                  <span>Keanggotaan Organisasi</span></a>
                <div class="sub-menu-w">
                  <div class="sub-menu-header">
