...
<html>
  <head>
    ...
    <link href="{{asset('/iniTemplate/dist/bower_components/select2/dist/css/select2.min.css')}}" rel="stylesheet">
    <link href="{{asset('/iniTemplate/dist/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}" rel="stylesheet">
    <link href="{{asset('/iniTemplate/dist/bower_components/dropzone/dist/dropzone.css')}}" rel="stylesheet">
    <link href="{{asset('/iniTemplate/dist/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('/iniTemplate/dist/bower_components/fullcalendar/dist/fullcalendar.min.css')}}" rel="stylesheet">
    <link href="{{asset('/iniTemplate/dist/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css')}}" rel="stylesheet">
    <link href="'{{asset('/iniTemplate/dist/bower_components/slick-carousel/slick/slick.css')}}" rel="stylesheet">
    <link href="{{asset('/iniTemplate/dist/css/main.css?version=4.5.0')}}" rel="stylesheet">
  </head>
  <body class="menu-position-side menu-side-left full-screen">
      ...
      <div class="layout-w">
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
          <div class="mm-logo-buttons-w">
            <a class="mm-logo" href="index.html"><img src="{{asset('/iniTemplate/dist/img/logo.png')}}"><span>Clean Admin</span></a>
          ...
          <div class="menu-and-user">
            <div class="logged-user-w">
              <div class="avatar-w">
                <img alt="" src="{{asset('/iniTemplate/dist/img/avatar1.jpg')}}">
              </div>
              ...
              <div class="os-dropdown light message-list">
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="{{asset('/iniTemplate/dist/img/avatar2.jpg')}}">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Phil Jones
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="{{asset('/iniTemplate/dist/img/avatar3.jpg')}}">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Bekky Simpson
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="{{asset('/iniTemplate/dist/img/avatar4.jpg')}}">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Alice Priskon
    ...
    <script src="{{asset('/iniTemplate/dist/bower_components/jquery/dist/jquery.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/popper.js/dist/umd/popper.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/moment/moment.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/chart.js/dist/Chart.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/select2/dist/js/select2.full.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/ckeditor/ckeditor.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap-validator/dist/validator.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/dropzone/dist/dropzone.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/editable-table/mindmup-editabletable.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/datatables.net/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/fullcalendar/dist/fullcalendar.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/tether/dist/js/tether.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/slick-carousel/slick/slick.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/util.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/alert.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/button.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/carousel.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/collapse.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/dropdown.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/modal.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/tab.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/tooltip.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/bower_components/bootstrap/js/dist/popover.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/js/dataTables.bootstrap4.min.js')}}"></script>
    <script src="{{asset('/iniTemplate/dist/js/demo_customizer.js?version=4.5.0')}}"></script>
    <script src="{{asset('/iniTemplate/dist/js/main.js?version=4.5.0')}}"></script>
    <script>
