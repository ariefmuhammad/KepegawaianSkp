    ...
    <div class="content-box">
      <div class="element-wrapper">
        ...
        <div class="element-box">
          ...
          <div class="form-desc">
            Ini adalah data riwayat kepangkatan anda, Silahkan di isi dengan lengkap.
          </div>
      ...
      <div class="modal-content text-center">
        ...
        <div class="onboarding-content with-gradient">
          ...
          <div class="onboarding-text">
            Tambahkan Data Riwayat Kepangkatan Anda Disini Dengan Lengkap.
          </div>
          <form>
            <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="">Golongan / Ruang</label><input class="form-control" placeholder="Contoh : Gol/ruang II/a ditulis 2A" type="text" value="" required="required">
            ...
            <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="">TMT Golongan / Ruang</label>
                    <div class="date-input">
                      <input class="single-daterange form-control" placeholder="Masukan TMT Golongan / Ruang..." type="text" value="04/12/1978" required="required">
                    </div>
                  </div>
                </div>
            </div>
...
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="editOnboardingFormModal" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-centered" role="document">
      <div class="modal-content text-center">
        ...
        <div class="onboarding-content with-gradient">
          <h4 class="onboarding-title">
            Ubah Data Riwayat Kepangkatan
          </h4>
          <div class="onboarding-text">
            Ubah Data Riwayat Kepangkatan Anda Yang Ingin Anda Ubah.
          </div>
          <form>
            <div class="row">
                <div class="col-sm-12">
...
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="deleteOnboardingTextModal" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-centered" role="document">
    <div class="modal-content text-center">
      ...
      <div class="onboarding-content with-gradient">
        <h4 class="onboarding-title">
          Hapus Data Riwayat Kepangkatan
        </h4>
        <div class="onboarding-text">
