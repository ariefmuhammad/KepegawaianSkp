      ...
      <div class="element-wrapper">
        ...
        <div class="element-box">
          <h5 class="form-header">
            Data Riwayat Diklat Teknis
          </h5>
          <div class="form-desc">
            Ini adalah data riwayat diklat teknis anda, Silahkan di isi dengan lengkap.
          </div>
      ...
      <div class="modal-content text-center">
        ...
        <div class="onboarding-content with-gradient">
          <h4 class="onboarding-title">
            Tambah Data Riwayat Diklat Teknis
          </h4>
          <div class="onboarding-text">
            Tambahkan Data Riwayat Diklat Teknis Anda Disini Dengan Lengkap.
          </div>
          <form>
            <div class="row">
                <div class="col-sm-12">
...
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="editOnboardingFormModal" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-centered" role="document">
      <div class="modal-content text-center">
        ...
        <div class="onboarding-content with-gradient">
          <h4 class="onboarding-title">
            Ubah Data Riwayat Diklat Teknis
          </h4>
          <div class="onboarding-text">
            Ubah Data Riwayat Diklat Teknis Anda Yang Ingin Anda Ubah.
          </div>
          <form>
            <div class="row">
                <div class="col-sm-12">
...
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="deleteOnboardingTextModal" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-centered" role="document">
    <div class="modal-content text-center">
      ...
      <div class="onboarding-content with-gradient">
        <h4 class="onboarding-title">
          Hapus Data Riwayat Diklat Teknis
        </h4>
        <div class="onboarding-text">
