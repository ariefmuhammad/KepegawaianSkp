...
Route::resource('dasar_pegawai', 'dasarPegawaiController');
Route::resource('riwayat_pendidikan_formal', 'riwayatPendidikanFormalController');
Route::resource('riwayat_diklat_fungsional', 'riwayatDiklatFungsionalController');
Route::resource('riwayat_diklat_teknis', 'riwayatDiklatTeknisController');
Route::resource('riwayat_diklat_penjenjangan', 'riwayatDiklatPenjenjanganStrukturalController');
Route::resource('riwayat_kepangkatan', 'riwayatDiklatFungsionalController');
Route::resource('riwayat_jabatan_struktural', 'riwayatJabatanStrukturalController');
Route::resource('riwayat_jabatan_fungsional', 'riwayatJabatanFungsionalController');
Route::resource('riwayat_pekerjaan_jabatan', 'riwayatPekerjaanJabatanController');
Route::resource('istri_suami', 'istriSuamiController');
Route::resource('anak', 'anakController');
Route::resource('keluarga_kandung', 'keluargaKandungController');
Route::resource('keluarga_istri_suami', 'keluargaIstriSuamiController');
Route::resource('seminar_lokakarya_simposium', 'seminarController');
Route::resource('tanda_jasa_penghargaan', 'penghargaanController');
Route::resource('hukum_disiplin', 'hukumanController');
Route::resource('keanggotaan_organisasi', 'organisasiController');
...
// Route::get('riwayat_diklat_fungsional_demo', function() {
//     return view('pegawai/content/riwayat_diklat_fungsional/index');
// });

// Route::get('riwayat_diklat_teknis_demo', function() {
//     return view('pegawai/content/riwayat_diklat_teknis/index');
// });

// Route::get('riwayat_diklat_penjenjangan_demo', function() {
//     return view('pegawai/content/riwayat_kepangkatan/index');
// });

// Route::get('riwayat_kepangkatan_demo', function() {
//     return view('pegawai/content/riwayat_diklat_penjenjangan/index');
// });

// Route::get('istri_suami_demo', function() {
//     return view('pegawai/content/istri_suami/index');
// });

// Route::get('anak_demo', function() {
//     return view('pegawai/content/anak/index');
// });

// Route::get('keluarga_kandung_demo', function() {
//     return view('pegawai/content/keluarga_kandung/index');
// });

// Route::get('keluarga_istri_suami_demo', function() {
//     return view('pegawai/content/keluarga_istri_suami/index');
// });

// Route::get('seminar_lokakarya_simposium_demo', function() {
//     return view('pegawai/content/seminar_lokakarya_simposium/index');
// });

// Route::get('tanda_jasa_penghargaan_demo', function() {
//     return view('pegawai/content/tanda_jasa_penghargaan/index');
// });

// Route::get('hukum_disiplin_demo', function() {
//     return view('pegawai/content/hukum_disiplin/index');
// });

// Route::get('keanggotaan_organisasi_demo', function() {
//     return view('pegawai/content/keanggotaan _organisasi/index');
// });
